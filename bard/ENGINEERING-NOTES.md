...
5. **Press boiler**: `PRESS_T = 0.85`. The crank keeps 0.95. The 0.95 calibration was made on
   free continuations of the crank; under the cams 0.85 buys ~5 points of fidelity for no rhyme.
...
7. **The verse-line corpus** (the big one): all seven folios regenerated from Gutenberg #1041
...
10. **All exhibit text updated** to match: cam chips, press plaques, schooling plaque,
    marginalia (both boiler settings and which lever each was measured on; the withdrawn
...
## Current measured state (unseeded, ~16–20 sheets, full schooling, all cams, T=0.85)
...
boiler pairing (crank 0.95 / press 0.85) · Witten–Bell only, no PART-conditioned backoff
...
powershell -File make_corpus_blocks.ps1              # groups into the seven folios
...
- The schooling interlock table in README was measured with the previous (catapult) rhyme
  cam; the goal-first spot-checks (tiers 0 and 6) are in the marginalia, but the full
  four-tier sweep has not been re-run.
