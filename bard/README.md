...
**The Subject Cam** is the sixth, added 2026-08-18 at Chris's request, and the closest of the cams to what a modern engine does with the question you ask it (attention to the prompt). It reads only the co-occurrence book (which verse lines two sorts have shared), so it can *keep* company the sonnets gave and cannot invent any. Measured with press_harness.js (12 sheets, seed 7, tier 4, T = 0.85, all cams) over four cards, subject.onSubjectPct = share of the sheet's full words that keep the card's company: **off** fidelity 75, on-subject 25 / 36 / 13 / 50 (*summer day* / *mistress' eyes* / *count the clock* / *love*); **0.15** 71, 37 / 44 / 27 / 56; **0.20** 70, 42 / 48 / 38 / 58; **0.25** 67, 46 / 50 / 43 / 60; **0.30** 64, 49 / 53 / 44 / 63. The knee is 0.20: five points of quotation for 8–25 of holding; past it the price steepens. Rhyme is unmoved within noise. Maillardet's automaton kept its poems on their subject with cams cut for each poem; ours is cut afresh from the card.
